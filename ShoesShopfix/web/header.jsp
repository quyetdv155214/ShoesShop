                            ...
                            <a href="checkout.jsp">
                                <h3>
                                    <div class="total">
                                        ...
                                        <% if(cart == null) cart = new ArrayList<Cart>(); %>
                                        <form action="checkout" method="get" id="checkout">
                                            
                                        </form>
                                        <p>
                                            <a href="javascript:{}" onclick="document.getElementById('checkout').submit(); return false;"class="simpleCart_empty"> $<%= Cart.totalMoney(cart) %>( <%= Cart.totalProduct(cart) %> )</a>
                                        </p>
                                    </div>
                                </h3>
                            </a>
