<%-- 
    Document   : single
    Created on : Dec 6, 2016, 3:11:47 PM
    Author     : Jic
--%>
                    ...
                    <div class="shocase-rt-bot">
                        <div class="float-qty-chart">
                            <ul>
                                ...
                                <li class="qty">
                                    <h4>QTY</h4>
                                    <form action="addtocart1" method="post" id="cart">
                        ...
                        <ul>
                            <li class="ad-2-crt simpleCart_shelfItem">
                                <a class="btn item_add" href="javascript:{}" onclick="document.getElementById('cart').submit(); return false;" role="button">Add To Cart</a>
